...
import FbTopBar from '../../Components/Layout/TopBar/FbTopBar'
...
import storys from '../../data/storyData.json';
import "./FbHome.css"
...
function FbHome() {
    ...
    // Add this useEffect in your FbHome component to fetch posts from database
    ...
    const createPost = async (postData) => {
        ...
        formData.append("username", "Peter");
        formData.append("profilePic", fb_profile);
        ...
        try {
            ...
            // Refresh posts list
            const updatedPosts = await axios.get(`${API_BASE_URL}/posts`);
            setPostList(updatedPosts.data);
    ...
    // Update handleLike to sync with backend
        ...
        <div>
            ...
            <div
                ...
                <div style={{
                    ...
                    <img src="https://static.xx.fbcdn.net/rsrc.php/v4/y7/r/Ivw7nhRtXyo.png" alt="video image icon" onClick={() => {
                                ...
                                <div key={story.id} style={{
                                    ...
                                    onMouseEnter={() => {
                                        ...
                                        if (video) {
                                            ...
                                            video.play().catch(e => console.log(e)); // catch errors
                                        }
                                    }}
                                    onMouseLeave={() => {
                                        const video = storyRef.current[index];
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            ...
                                            <div style={{
                                                ...
                                                <img src={post.profilePic || fb_profile} alt="profilePic" style={{ borderRadius: "50%" }} />
                                            </div>
