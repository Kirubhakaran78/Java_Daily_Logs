...
import { GamingIcon, GroupsIcon, HomeIcon, MarketplaceIcon, PlayIcon } from './FbNavIcons';
            ...
            <Navbar bg="light" className="shadow-sm topbar" style={{ height: "60px" }}>
                <Container fluid className="d-flex align-items-center justify-content-between">
                    ...
                    <Nav className="fb-center-nav">
                        <Nav.Link as={NavLink} to="/HomePage/facebook" className="fb-nav-link" end>
                            {({ isActive }) => (
                                <HomeIcon fill={isActive ? "#0866ff" : "#65676b"} />
                            )}
                        </Nav.Link>

                        <Nav.Link as={NavLink} to="/HomePage/facebook/reels" className="fb-nav-link">
                            {({ isActive }) => (
                                <PlayIcon fill={isActive ? "#0866ff" : "#65676b"} />
                            )}
                        </Nav.Link>

                        <Nav.Link as={NavLink} to="/HomePage/facebook/marketplace" className="fb-nav-link">
                            {({ isActive }) => (
                                <MarketplaceIcon fill={isActive ? "#0866ff" : "#65676b"} />
                            )}
                        </Nav.Link>

                        <Nav.Link as={NavLink} to="/HomePage/facebook/groups" className="fb-nav-link">
                            {({ isActive }) => (
                                <GroupsIcon fill={isActive ? "#0866ff" : "#65676b"} />
                            )}
                        </Nav.Link>

                        <Nav.Link as={NavLink} to="/HomePage/facebook/gaming" className="fb-nav-link">
                            {({ isActive }) => (
