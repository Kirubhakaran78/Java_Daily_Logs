        ...
        <Modal {...props} size="lg" centered>
            ...
            <Modal.Body style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <img src={post.profilePic || fb_profile} alt="profile pic"
                ...
                {post.backgroundStyle ? (
                ...
                ) : post.fileType === 'video' && post.postImage ? (
                    // Video post
                    <video
                        src={post.postImage}
                        style={{ width: '100%', borderRadius: '8px', marginTop: '8px',maxHeight:'500px' }}
                        controls
                    />
                ) : post.fileType === 'image' && post.postImage ? (
                    // Image post
                    <img
                        src={post.postImage}
                    ...
                    // Plain text
                    <div style={{ padding: '0 16px 8px 16px', fontSize: '16px' }}>
                        {post.content}
                    </div>
                )}
