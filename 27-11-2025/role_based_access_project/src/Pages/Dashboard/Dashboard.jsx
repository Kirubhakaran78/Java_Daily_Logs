      ...
      try {
        ...
        if (currentUser?.username) {
          const userRes = await axios.get(
            `http://localhost:${config.BASE_URL}/Org_Management_java/api/users/currentUser?username=${currentUser.username}`
          );
        ...
        const [empRes, prodRes, revRes, perfRes, compRes] = await Promise.all([
          axios.get(`http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getAllEmp`),
          axios.get(`http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getAllProduct`),
          axios.get(`http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getAllRevenue`),
          axios.get(`http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getCompanyPerformance`),
          axios.get(`http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getProductComparison`),
        ]);
        ...
        if (userRole === "ADMIN") {
          ...
          const revByProd = await axios.get(
            `http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getRevenueByProduct`
          );
          ...
          const [perfRes, yearRes, clientsRes, growthRes] = await Promise.all([
            axios.get(
              `http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getProductPerformance?productName=${userProduct}`
            ),
            axios.get(
              `http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getYearComparison?productName=${userProduct}`
            ),
            axios.get(
              `http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getTopClients?productName=${userProduct}`
            ),
            axios.get(
              `http://localhost:${config.BASE_URL}/Org_Management_java/api/masters/getMonthlyGrowth?productName=${userProduct}`
            ),
          ]);
