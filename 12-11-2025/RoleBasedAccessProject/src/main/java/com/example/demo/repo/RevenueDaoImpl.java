...
public class RevenueDaoImpl implements RevenueDao {
	...
	public Map<String, Object> save(Map<String, Object> jsonData) {
	    ...
	    String sql = "INSERT INTO revenue (revenue_id, product_name, month_year, revenue_amount, expense_amount, profit, client_name) " +
	                 "VALUES ('" + revenue_id + "', '" + product_name + "', '" + month_year + "', '" + 
	                 revenue_amount + "', '" + expense_amount + "', '" + profit + "', '" + client_name + "')";
	    
	    jdbcTemplate.update(sql);
	    System.out.println("Inserted revenue record: " + revenue_id);
	...
	public List<Map<String, Object>> findAll() {
	    String fetchSql = "SELECT * FROM revenue ORDER BY id DESC";
