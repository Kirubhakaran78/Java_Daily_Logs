...
//            role = "EMPLOYEE";  // or whatever default you want
//        }
//        
//        String product_name = (String) jsonData.getOrDefault("product_name", "");
//     
//        
//        String insertSql = "INSERT INTO loginTable(username, password, role, product_name) VALUES ('"+username+"', '"+password+"', '"+role+"', '"+product_name+"')";
...
//        String empSql = "INSERT INTO employee (emp_name, emp_email, emp_role, product_id, is_active, status) VALUES (?, ?, ?, ?, ?, ?)";
//       jdbcTemplate.update(empSql, username, username, role, product_id, false, "IN_PROGRESS");
////        jdbcTemplate.update(empSql,"IN_PROGRESS");
//
//    }
//
//    @Override
...
//        jdbcTemplate.update(updateLoginSql, role, product_name, username);
//        
//        // Get product_id from product_name
//        Integer product_id = null;
//        if (product_name != null && !product_name.isEmpty()) {
...
//        String updateEmpSql = "UPDATE employee SET emp_role=?, product_id=? WHERE emp_email=? OR emp_name=?";
//        jdbcTemplate.update(updateEmpSql, role, product_id, username, username);
//    }
//}
