...
export default function Dashboard() {
  ...
  //Bar chart data
  // const data = [
  //   { product_name: "LIMS", budget_per_annum: 1200000, total_employees: 16 },
  //   { product_name: "SDMS", budget_per_annum: 950000, total_employees: 5 },
  //   { product_name: "ELN", budget_per_annum: 600000, total_employees: 3 },
  //   { product_name: "DMS", budget_per_annum: 700000, total_employees: 3 }
  // ];
