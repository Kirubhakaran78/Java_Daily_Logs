        ...
        >
            ...
            <Modal.Body>
                <div style={{ display: "flex", justifyContent: "start", alignItems: "center" }}>
                    ...
                    />
                    <span style={{ color: "#080809", marginLeft: "15px" }}> Peter </span>
                </div>
                <textarea
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: "20px", color: "#080809", fontWeight: "600" }}>Add Post </p>
                    <div style={{
                        display: "flex",
                        justifyContent: "space-between",
                        alignItems: "center"
                        ...
                        <img src="https://static.xx.fbcdn.net/rsrc.php/v4/yd/r/pkbalDbTOVI.png" alt="flag icon" style={{ marginLeft: "10px" }} />
                        <div style={{
                            width: '36px',
                            height: '36px',
                            borderRadius: '50%',
